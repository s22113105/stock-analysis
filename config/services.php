...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    | 期貨交易所 API 設定
    | 官方網站: https://www.taifex.com.tw
    */
    'taifex' => [
        'base_url' => env('TAIFEX_BASE_URL', 'https://www.taifex.com.tw'),
        'timeout' => env('TAIFEX_TIMEOUT', 30),
        'retries' => env('TAIFEX_RETRIES', 3),
        'cache_ttl' => env('TAIFEX_CACHE_TTL', 300), // 快取時間 (秒)
        'delay_between_requests' => env('TAIFEX_DELAY', 500), // 請求間隔 (毫秒)
    ],
